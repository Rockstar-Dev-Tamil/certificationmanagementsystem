...
import { Plus, Search, Award, TrendingUp, Filter, RefreshCcw, MoreHorizontal, Eye, Trash2, ShieldCheck, UserCheck } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
          ...
          <div className="flex gap-4 w-full md:w-auto">
            <button className="flex-1 md:flex-none p-4 bg-white border border-slate-200 rounded-2xl text-slate-600 hover:bg-slate-50 transition-colors">
